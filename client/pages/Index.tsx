...
export default function Index() {
  const services = useMemo(
    () => [
      { icon: <Code2 />, title: "Web Development", desc: "Custom websites and web applications built with the latest technologies to deliver exceptional user experiences." },
      { icon: <Phone />, title: "Mobile App Development", desc: "Native and cross-platform mobile applications that engage users and drive business growth." },
      { icon: <Cloud />, title: "Cloud Solutions", desc: "Scalable cloud infrastructure and migration services to optimize your operations and reduce costs." },
      { icon: <Database />, title: "Data Analytics", desc: "Transform your data into actionable insights with our advanced analytics and visualization solutions." },
      { icon: <Lock />, title: "Cybersecurity", desc: "Protect your digital assets with our comprehensive security assessments and solutions." },
      { icon: <Brain />, title: "AI & Machine Learning", desc: "Leverage AI to automate processes and gain competitive advantages through intelligent features." },
    ],
    [],
  );
  ...
  return (
    <div id="home">
      ...
      <section id="about" className="container py-16 md:py-24">
        <SectionTitle title="About Us" subtitle="Learn more about Azorix Technologies and our mission" />
        <div className="grid gap-10 md:grid-cols-2 items-center">
          ...
          <div>
            ...
            <p className="mt-3 text-muted-foreground">
              Azorix Technologies is a forward-thinking technology company dedicated to helping businesses thrive in the digital age. Founded in 2019, we've rapidly established ourselves as a trusted partner for organizations seeking innovative tech solutions.
            </p>

            <h4 className="mt-6 text-lg font-semibold">Our Mission</h4>
            <p className="mt-2 text-muted-foreground">
              Our mission is to empower businesses through technology, delivering solutions that are not just functional but transformative. We believe in creating technology that makes a meaningful difference.
            </p>
            ...
            <div className="mt-6 grid grid-cols-3 gap-4">
              ...
              <div className="rounded-xl border bg-white p-4 text-center shadow-sm">
                ...
                <div className="text-xs text-muted-foreground">Expert Team Members</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="mx-auto max-w-4xl rounded-2xl border bg-white p-8 shadow-xl">
            <div className="text-center">
              ...
              <p className="mt-4 text-muted-foreground">Simplify Food Ordering Process with our Restaurant App — click the image to view the live site.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="services" className="container py-16 md:py-24">
        <SectionTitle title="Our Services" subtitle="Comprehensive technology solutions for your business needs" />
      ...
      <section id="portfolio" className="bg-slate-50/80 py-16 md:py-24">
        <div className="container">
          <SectionTitle title="Our Portfolio" subtitle="Explore some of our recent projects" />
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <a href="https://nipige.com/" target="_blank" rel="noreferrer noopener" className="block rounded-xl overflow-hidden">
              <img src="https://cdn.builder.io/api/v1/image/assets%2F1b9c62c1213140709e07580a4ee1f322%2Fbc943ca84d2a4a93ac09b72fdb405836?format=webp&width=800" alt="portfolio1" className="w-full h-40 object-cover" />
            </a>
            <a className="block rounded-xl overflow-hidden">
              <img src="https://cdn.builder.io/api/v1/image/assets%2F1b9c62c1213140709e07580a4ee1f322%2F613e7e26f2f443f391fea781db37b1bf?format=webp&width=800" alt="portfolio2" className="w-full h-40 object-cover" />
            </a>
        ...
        <div className="mx-auto max-w-3xl">
          <div className="rounded-2xl border bg-white p-8 shadow-sm">
            ...
            <div className="mt-6 flex items-center gap-4">
              <div className="h-12 w-12 rounded-full bg-cyan-50 grid place-items-center text-cyan-600">{/* avatar placeholder */}
                <Star />
              </div>
              <div>
          ...
          <div className="mt-6 flex items-center justify-center gap-3">
            <Button variant="outline" size="sm" onClick={() => setTIndex((tIndex - 1 + testimonials.length) % testimonials.length)}>Prev</Button>
            <div className="flex items-center gap-2">
              {testimonials.map((_, i) => (
                <button
                  ...
                  onClick={() => setTIndex(i)}
                  className={"h-2.5 w-6 rounded-full transition " + (i === tIndex ? "bg-cyan-600" : "bg-slate-300 hover:bg-slate-400")}
                />
              ))}
            </div>
            <Button variant="outline" size="sm" onClick={() => setTIndex((tIndex + 1) % testimonials.length)}>Next</Button>
          </div>
        </div>
      </section>
        ...
        <div className="container grid gap-10 md:grid-cols-2 items-start">
          <div>
            ...
            <ul className="space-y-4 text-muted-foreground">
              <li>
                <strong className="text-foreground">Our Location:</strong> 500 Market St, San Francisco, CA
              </li>
              <li>
                <strong className="text-foreground">Email Us:</strong> hello@azorix.com
              </li>
              <li>
                <strong className="text-foreground">Call Us:</strong> +1 (555) 555‑1234
              </li>
            </ul>
          </div>
